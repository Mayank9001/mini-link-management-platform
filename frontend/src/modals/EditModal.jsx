  ...
  const getData = async () => {
    ...
    try {
      ...
      setLinkData({
        ...
        newExpirationDate: data.link.expirationDate
          ? new Date(data.link.expirationDate)
          : null,
      });
      setIsToggle(hasExpirationDate);
      setSelectedDate(
        data.link.expirationDate ? new Date(data.link.expirationDate) : ""
      );
    } catch (error) {
      console.log(error);
    }
        ...
        <div className={styles.container}>
          ...
          <div className={styles.destination}>
            ...
            <input
              ...
              onChange={(e) =>
                handleInputChange("newOriginalLink", e.target.value)
              }
              placeholder="https://web.whatsapp.com/"
              style={errors.originalLink ? { border: "1px solid red" } : {}}
            />
            <p
              style={{ visibility: errors.originalLink ? "visible" : "hidden" }}
            >
          ...
          <div className={styles.remarks}>
            ...
            <textarea
              ...
              onChange={(e) => handleInputChange("newRemarks", e.target.value)}
          ...
          <div className={styles.footer}>
            ...
            <button className={styles.createbtn} onClick={handleUpdateLink}>
              Save
            </button>
          </div>
        </div>
