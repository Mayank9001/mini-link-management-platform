              ...
              <table className={styles.linkstable} style={{borderRight:"none"}}>
                <thead>
                  <tr>
                    ...
                    <th>Remarks</th>
                    <th>Clicks</th>
                    <th style={{display:"flex", gap: "1vw", justifyContent:"center",paddingTop:"2.7vh"}}>Status<PiCaretUpDown onClick={()=>{setStatus(status==="Inactive"?"Active":"Inactive");handleStatusSorting();}} /></th>
                    <th>Actions</th>
                  </tr>
                </thead>
                <tbody>
